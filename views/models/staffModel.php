...
Class staffModel extends _Db{
	public function exam_list($user_id){
		$sql = "SELECT  *,department_name FROM exams,department WHERE exams.department_id=department.department_id ORDER BY department.department_id ASC";
    ...
    public function examsresult() {
            ...
            $WHERE = "  ORDER BY exams.exam_id, transaction.user_id ASC";
    ...
    public function loadExams() {
            ...
            $WHERE = " LEFT JOIN department ON exams.department_id = department.department_id  ORDER BY exam_id ASC";
