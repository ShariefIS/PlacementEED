  ...
  <head>
   ...
   <body>    
    ...
    <section id="slider">
                   ...
                   <div style="position:absolute;top: 110px;left:200px;" class="slider_caption">
                    <h2 style="position:absolute;left:100px;"><marquee direction="right" behavior="alternate" >Welcome to Dr.IMRAN placement platform!</marquee></h2>
    ...
    <section id="aboutUs" style="background-image:url(img/slider/quiz.jpg );">
        <div class="container"  >
        <div class="row">
        <!-- Start about us area -->
...
<form name="newuser" id="newuser">
  <div style="width: 100%; padding-top: 10px;position: relative; left: 150px;">
      ...
      <div class="container">
       <!-- Our courses titile -->
        <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">Tips and Tricks</h2>
              <span></span> 
            </div>
          </div>
        </div>
            ...
            <div class="ourCourse_content">
              <ul class="course_nav">
                <li>
                  <div class="single_course">
                    <div class="singCourse_imgarea">
                      <img src="img/Deloitte-Logo.jpg" />
                      <div class="mask">                         
                        <a href="#" class="course_more">View</a>
                      </div>
                    </div>
                    <div class="singCourse_content">
                    <h3 class="singCourse_title"><a href="#">Deloitte</a></h3>
         
                    <p>Deloitte is an IT consulting firm. It is headquartered in New York City, United States. The main function of the company is that it offers a range of tax, consulting & financial advisory, audit & enterprise risk and risk management services</p>
                    </div>
                ...
                <li>
                  <div class="single_course">
                    <div class="singCourse_imgarea">
                      <img src="img/Capgemini.jpg" />
                      <div class="mask">                         
                        <a href="capgemini.php" class="course_more">View</a>
                      </div>
                    </div>
                    <div class="singCourse_content">
                    <h3 class="singCourse_title"><a href="#">Capgemini</a></h3>
                 
                    <p>Capgemini is a French multinational information technology consulting corporation. It provides world's largest IT consulting, outsourcing and professional services companies .It was founded in 1967 by Serge Kampf in Grenoble, France.</p>
                    </div>
