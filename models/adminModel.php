...
Class adminModel extends _Db {
    ...
    public function addnewuser($user_fname, $user_lname, $user_name, $user_password,$dept, $enabled=1, $user_id, $ischecker) {
        $this->insert('users', array('user_fname' => "'$user_fname'", 'user_lname' => "'$user_lname'", 'user_name' => "'$user_name'",
            'user_password' => "'$user_password'",'dept'=>"'$dept'", 'user_enabled' => $enabled, 'user_createdby' => $user_id));
    }
    ...
    public function signupadd($user_fname, $user_lname, $user_name, $user_password, $dept) {
        ...
        if (is_array($result)) {
            ...
            $this->insert('users', array('user_fname' => "'$user_fname'", 'user_lname' => "'$user_lname'", 'user_name' => "'$user_name'",
                'user_password' => "'$user_password'", 'dept'=>"'$dept'"));
            echo "0";
    ...
    public function loadExams() {
            ...
            $WHERE = " LEFT JOIN department ON exams.department_id = department.department_id  ORDER BY department.department_id ASC";
    ...
    $sql = "SELECT * FROM transaction 
				...
				INNER JOIN exams ON transaction.exam_id = exams.exam_id 
				 ORDER BY exams.exam_id, transaction.user_id ASC";
